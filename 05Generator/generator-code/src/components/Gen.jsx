        ...
        <>
            <div className='w-full max-w-md mx-auto shadow-md rounded-lg px-4 py-3 my-8 text-orange-500 bg-gray-600'>
                ...
                <div className=' flex shadow rounded-lg overflow-hidden mb-4'>
                    ...
                    <input ref={passwordRef} className="outline-none w-full py-1 px-3" type="text" value={password} placeholder="Password" readOnly />
                ...
                <div className='flex text-sm gap-x-2'>
                    <div className="flex item-center gap-x-1">
                        ...
                        <input type="checkbox" defaultChecked={numberAllowed} id='numberInput' className='cursor-pointer' onChange={() => {
